  ...
  data: [
    {
      ...
      __v: 0,
      id: "65294bacd51217f395cac575",
    },
    {
      _id: "65294be1d51217f395cac578",
      ...
      __v: 0,
      id: "65294be1d51217f395cac578",
    },
    {
      _id: "65294c4ed51217f395cac57b",
      ...
      __v: 0,
      id: "65294c4ed51217f395cac57b",
    },
    {
      _id: "6541cce5b4bbe14e2f986cb2",
...
describe("HospitalCatalog", () => {
  it("should have correct number of hospital images", async () => {
    const hospitalCatalog = await HospitalCatalog({
      hospitalsData: new Promise((resolve) => resolve(mockData)),
    });
    render(hospitalCatalog);
    await waitFor(() => {
      const hospitalImages = screen.queryAllByRole("img");
      expect(hospitalImages.length).toBe(mockData.data.length);
    });
  });
});
